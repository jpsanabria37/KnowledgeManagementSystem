            ...
            <div class="card-body">
                <form action="{{ route('centros.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre_centro" class="form-control" id="nombre_centro" value="{{ old('nombre_centro') }}" placeholder="Ingrese el nombre del centro" required autocomplete="off">
                    </div>
