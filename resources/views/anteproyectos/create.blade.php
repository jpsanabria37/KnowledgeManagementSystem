...
@section('title', 'Crear Anteproyecto')
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Formulario para crear un nuevo anteproyecto</h3>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('anteproyectos.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea name="objetivo_general" class="form-control" required>{{ old('objetivo_general') }}</textarea>
                </div>

                <!-- Campo Objetivos Específicos -->
                <div class="form-group">
                    <label for="objetivos_especificos">Objetivos Específicos</label>
                    <textarea name="objetivos_especificos" class="form-control" required>{{ old('objetivos_especificos') }}</textarea>
                </div>

                <!-- Campo Justificación -->
                <div class="form-group">
                    <label for="justificacion">Justificación</label>
                    <textarea name="justificacion" class="form-control" required>{{ old('justificacion') }}</textarea>
                </div>

                <!-- Campo Alcance -->
                <div class="form-group">
                    <label for="alcance">Alcance</label>
                    <textarea name="alcance" class="form-control">{{ old('alcance') }}</textarea>
                </div>

                <!-- Campo Metodología -->
                <div class="form-group">
                    <label for="metodologia">Metodología</label>
                    <textarea name="metodologia" class="form-control">{{ old('metodologia') }}</textarea>
                </div>

                <!-- Campo Cronograma -->
                <div class="form-group">
                    <label for="cronograma">Cronograma</label>
                    <textarea name="cronograma" class="form-control">{{ old('cronograma') }}</textarea>
                </div>
