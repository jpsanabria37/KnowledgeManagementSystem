            ...
            <div class="card-body">
                <form action="{{ route('lineas.update', $linea->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre_linea" class="form-control" id="nombre_linea" value="{{ old('nombre_linea', $linea->nombre_linea) }}" placeholder="Ingrese el nombre de la línea" required autocomplete="off">
                    </div>
